...
const INITIAL_DAILY_SCHEDULES: DailyScheduleItem[] = [
  {
    id: 's1',
    title: 'ថ្វាយបង្គំព្រះពេលព្រឹក និងចម្រើនសមាធិភាវនា',
    start_time: '០៤:៣០',
    end_time: '០៥:៣០',
    ...
    location: 'ព្រះវិហារ',
    supervisor_name: 'ព្រះវិន័យធរ ឌុក សម្បត្តិ',
    supervisor_role: 'ព្រះវិន័យធរ',
    participants: 'ព្រះសង្ឃគ្រប់អង្គ',
    notes: 'វត្តមានកំហិតរាល់ព្រឹក',
    photo_url: null,
  },
  {
    id: 's2',
    title: 'ទទួលចង្ហាន់ពេលព្រឹក (និមន្តបិណ្ឌបាត)',
    start_time: '០៦:០០',
    end_time: '០៧:០០',
    start_date: '2026-01-01',
    end_date: '2026-12-31',
    session: 'morning',
    days: ['sun', 'mon', 'tue', 'wed', 'thu', 'fri', 'sat'],
    location: 'សាលាឆាន់ & តាមភូមិ',
    supervisor_name: 'ព្រះមេកុដិ ឡុង សារ៉េត',
    supervisor_role: 'ព្រះមេកុដិ',
    participants: 'ព្រះសង្ឃ និងសិស្សវត្ត',
    notes: 'រៀបចំជួរតាមវស្សា',
    photo_url: null,
  },
  {
    id: 's3',
    title: 'ម៉ោងសិក្សាពុទ្ធិកសិក្សា និងធម្មវិន័យ',
    start_time: '០៧:៣០',
    end_time: '១០:៤៥',
    start_date: '2026-01-01',
    end_date: '2026-12-31',
    ...
    location: 'សាលាពុទ្ធិកសិក្សា',
    supervisor_name: 'ព្រះគ្រូបង្រៀន សេង សុវណ្ណារ៉ា',
    supervisor_role: 'ធម្មាចារ្យ',
    participants: 'សាមណេរ និងភិក្ខុសិស្ស',
    notes: 'ត្រូវត្រួតពិនិត្យវត្តមានកត់ត្រា',
    photo_url: null,
  },
  {
    id: 's4',
    title: 'ឆាន់ចង្ហាន់ថ្ងៃត្រង់',
    start_time: '១១:០០',
    end_time: '១២:០០',
    start_date: '2026-01-01',
    end_date: '2026-12-31',
    ...
    days: ['sun', 'mon', 'tue', 'wed', 'thu', 'fri', 'sat'],
    location: 'សាលាឆាន់',
    supervisor_name: 'ព្រះគ្រូសូត្រស្ដាំ ឡុង សារ៉េត',
    supervisor_role: 'គ្រូសូត្រ',
    participants: 'ព្រះសង្ឃគ្រប់អង្គ',
    notes: 'ឆាន់រួមគ្នាដោយសេចក្ដីស្ងប់',
    photo_url: null,
  },
  {
    id: 's5',
    title: 'បោសសម្អាតបរិវេណវត្ត និងកុដិ',
    start_time: '១៧:០០',
    end_time: '១៨:០០',
    start_date: '2026-01-01',
    end_date: '2026-12-31',
    session: 'evening',
    days: ['sun', 'mon', 'tue', 'wed', 'thu', 'fri', 'sat'],
    location: 'បរិវេណវត្ត & កុដិ',
    supervisor_name: 'អនុកុដិទី១ សុខ វិបុល',
    supervisor_role: 'អនុកុដិទី១',
    participants: 'សាមណេរ និងសិស្សវត្ត',
    notes: 'ចែកវេនទទួលខុសត្រូវតាមកុដិ',
    photo_url: null,
  },
  {
    id: 's6',
    title: 'ថ្វាយបង្គំព្រះពេលល្ងាច សូត្រធម៌ និងស្ដាប់ឱវាទ',
    start_time: '១៨:៣០',
    end_time: '១៩:៣០',
    start_date: '2026-01-01',
    end_date: '2026-12-31',
    ...
    days: ['sun', 'mon', 'tue', 'wed', 'thu', 'fri', 'sat'],
    location: 'ព្រះវិហារ',
    supervisor_name: 'ព្រះគ្រូចៅអធិការ',
    supervisor_role: 'ចៅអធិការ',
    participants: 'ព្រះសង្ឃគ្រប់អង្គ',
    notes: 'ស្ដាប់ការអប់រំ និងផ្សាយមេត្តា',
    photo_url: null,
  }
]
...
const INITIAL_EVENTS: EventItem[] = [
  {
    id: '1',
    title: 'ពិធីបុណ្យកឋិនទានសាមគ្គី',
    title_en: 'Kathina Ceremony',
    description: 'ពិធីដង្ហែត្រៃចីវរ និងបច្ច័យបូជាទូទាំងវត្ត',
    event_type: 'ceremony',
    start_date: '2026-10-25',
    end_date: '2026-10-26',
    location: 'សាលាឆាន់ និង ព្រះវិហារ',
    budget: 5000000,
  },
  {
    id: '2',
    title: 'បុណ្យភ្ជុំបិណ្ឌ (បិណ្ឌធំ)',
    title_en: 'Pchum Ben Festival',
    description: 'ការរៀបចំពិធីបង្សុកូល និងការប្រគេនចង្ហាន់ដល់ព្រះសង្ឃ',
    event_type: 'ceremony',
    start_date: '2026-09-28',
    end_date: '2026-10-01',
    location: 'វត្តអារាមទាំងមូល',
    budget: 3500000,
  }
]
